export default [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/pages/settings/overview/Notification.vue'),
      },
    ],
  },
  {
  ...
  {
    path: '/page/testPageThiDau',
    name: 'testPageThiDau',
    component: () => import('@/views/testComponentInsight/testPageThiDau/testPageThiDau.vue'),
  },
];
